...
// The custom-SVG iconography used by the minimal skin (no emoji, no fills);
// the modern skin uses emoji for nav/tiles. Paths from the design handoff.
...
/** Emoji the modern skin shows in place of the SVG icon (nav tiles / home). */
